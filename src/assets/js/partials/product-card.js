...
class ProductCard extends HTMLElement {
  ...
  getDigitalBadge() {
    if (this.showDigitalBadge && (this.product.type === 'digital' || this.product.type === 'codes')) {
      return `<div class="s-product-card-promotion-title s-product-card-digital-badge"><i class="sicon-box-open"></i> تسليم فوري</div>`
    }
    return '';
  }
    ...
    this.innerHTML = `
        ...
        : this.fitImageHeight
          ...
          : 'cover'} lazy"
            ...
            ${!this.fullImage && !this.minimal ? this.getDigitalBadge() : ''}
          </a>
